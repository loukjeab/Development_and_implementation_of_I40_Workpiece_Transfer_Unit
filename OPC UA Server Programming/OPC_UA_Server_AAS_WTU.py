...
async def main():
    ...
    server.set_server_name("I40 Workpiece Transfer Unit")
    ...
    # Get node from AAS of Workpiece Trasnfer Unit in XML format and link method for function of checking number of queue 
    ...
    # Get node from AAS of Workpiece Trasnfer Unit in XML format and link method for function of service
    service_method_from_xml = server.get_node("ns=3;i=1630")
    server.link_method(service_method_from_xml, service)

    # Get nodes from AAS of the Workpiece Transfer Unit in XML format for various attributes
